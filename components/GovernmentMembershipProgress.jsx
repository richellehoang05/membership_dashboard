...
const STAGES = ["Enrolled", "Policy Engaged", "Implementation Active", "Strategic Leader"];

/**
 * Horizontal stepper for Government Membership progression.
 * @param {string} currentStage - One of STAGES; steps up to and including this are completed.
 */
export default function GovernmentMembershipProgress({ currentStage = "Enrolled" }) {
          ...
          return (
            <div key={label} className="flex flex-1 items-center min-w-0">
              ...
              <div className="flex flex-col items-center shrink-0">
                ...
                <span
                  className={[
                    "mt-2 text-xs font-medium truncate max-w-[5.5rem] text-center",
